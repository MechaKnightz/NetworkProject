...
std::vector<Texture> ModelComponent::LoadMaterialTextures(aiMaterial* mat, aiTextureType type, std::string typeName)
{
    std::vector<Texture> textures;
...
uint32_t ModelComponent::TextureFromFile(const std::string& uri, const std::string& directory)
{
